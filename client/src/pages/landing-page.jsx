        ...
        <div className="min-h-screen w-full container mx-auto px-4">
            ...
            Bharat Philately
                    ...
                    <div className="text-gray-600 text-center mt-4 text-sm md:text-md max-w-3xl mx-auto">
                        Bharat Philately is a premier platform dedicated to
                        Indian stamp collectors, showcasing India's rich postal
                        history, cultural heritage, and rare philatelic
                        material.
                    </div>
                </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        {LandingPageCards.map((card) => (
                            <div
                                key={card.id}
                                id={card.id}
                                className="bg-white shadow-lg rounded-lg overflow-hidden w-full sm:w-64 md:w-80 transition-transform transform hover:scale-105"
                            >
                                <img
                                    src={card.path}
                                    alt="Stamp"
            ...
            <div className="py-16 flex flex-col items-center justify-center space-y-8">
                ...
                <p className="text-lg text-gray-700 text-center max-w-2xl">
                    Access philatelic material from across India, order online,
            ...
            <div className="py-16">
                <h2 className="text-5xl font-bold text-center text-gray-800 mb-12">
                    Why Choose Bharat Philately?
                </h2>
                <div className="grid grid-cols-1 max-w-4xl md:grid-cols-2 gap-8 text-center mx-auto">
                    {LandingPageFeatures.map((feature) => (
                        <div
                            key={feature.id}
                            className="p-8 bg-white shadow-lg rounded-lg transition-transform transform hover:scale-105 hover:shadow-xl"
                        >
                            <img
                                src={feature.path}
                                alt="Centralized Access"
            ...
            <div className="py-16">
                <h2 className="text-4xl font-extrabold text-center text-gray-800 mb-8">
                    Philatelist Spotlight
                </h2>
                <div className="flex flex-wrap justify-center gap-8">
                    {LandingPageSpotlight.map((spotlight) => (
                        <div
                            key={spotlight.id}
                            className="bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 max-w-xs"
                        >
                            <img
                                src={spotlight.image}
                                alt="Philatelist 1"

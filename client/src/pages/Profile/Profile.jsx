        ...
        <div className="w-full flex justify-center px-4 md:px-10 py-10">
            <div className="w-full max-w-4xl bg-white rounded-md shadow-sm">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="text-sm text-gray-500">
                                {user.profession}, {user.Address.city},{" "}
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <div className="w-full md:max-w-xs bg-gradient-to-tr from-teal-500 to-cyan-400 text-white p-4 rounded-lg shadow-lg">
                            ...
                            <div className="mt-6">
                                ...
                                <div className="uppercase tracking-wide text-xs font-bold">
                                    {user.NPDA.accountNo}
                                </div>
                            </div>
                        </div>
                ...
                <div className="bg-slate-500 text-white py-4 px-5 mt-5 rounded-lg shadow-lg">
                    ...
                    <p className="mb-4">
                        User has achieved the following rewards and badges in
                        philately:
                    </p>
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            />
                            <span className="text-center">
                                Philatelic Community Leader Badge
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-3 py-2 bg-[#fff] mt-4">
                    <div className="flex gap-4">
                        <div className="px-2 py-1 border shadow-sm bg-[#d7d7d7] rounded-sm">
                            Transactions
                        </div>
                        <div className="px-2 py-1  border shadow-sm bg-white rounded-sm">
                            Orders
                        </div>
                    </div>
                    <div className="">
                        {orders.map((it) => {
                            return (
                                <div
                                    key={it.date}
                                    className="py-2 bg-white flex justify-between  items-center px-2 border-2 rounded-md border-[#b4afaf21] my-3"
                                >
                                    ...
                                    <div className="flex w-[40%] justify-between gap-10">
                                        <div
                                            className={
                                                it.status == "success"
                                                    ? "text-teal-600 font-[700] uppercase text-[13px]"
                                                    : " font-[700] uppercase text-[13px] text-red-400"
                                            }
                                        >
                                            {it.status}
                                        </div>
                                        <div className="font-[600] pr-3">
                                            ₹ {it.amount}
                                        </div>
                                    </div>
                                </div>
